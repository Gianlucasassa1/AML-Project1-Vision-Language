...
def parse_arguments():
    ...
    parser.add_argument('--weights', type=json.loads, default="[10, 0.1, 0.1, 1, 0.3]", help="if set, the experiment will run on different weights than the default value. Format: --weights=[weight1, weight2, weight3, alpha, clip_weight]") #weight1, weight2, weight3, alpha, clip
